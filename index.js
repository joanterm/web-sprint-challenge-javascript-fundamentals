...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// It can access it because of how how nested functions work- scoping. We can access all variables and scope 
// outside of nestedFunction (that includes variables "internal" and "external") but we wouldn't be able
// to access a variable created in a new function inside nestedFunction.
...
console.log(animalNames(zooAnimals))
 ...
 function lowerCaseNames(array){
  const newArrayLowerCase = array.map((item) => {
      return item.animal_name.toLowerCase()
  })
  return newArrayLowerCase
}
...
console.log(lowerCaseNames(zooAnimals))
 ...
 function lowPopulationAnimals(array){
  const newArrayLowPopulation = array.filter((item) => {
      return item.population < 5
  })
  return newArrayLowPopulation
}
 ...
 function USApop(array){
  const totalPopulation = array.reduce((acculumator, item) => {
      return acculumator + item.population
  }, 0)
